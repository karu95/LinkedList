...
pthread_mutex_t list_mutex = PTHREAD_MUTEX_INITIALIZER; // Mutex initialization for synchronization. 
...
void *thread_routine(void* params) {
    ...
    struct thread_routine_params *parameters = (struct thread_routine_params*) params;
    
    int mem_samples = parameters->member_operations;
    int insert_samples = parameters->insert_operations;
    int delete_samples = parameters->delete_operations;
